...
gitem_t bg_itemlist[] = {
	...
	{"item_armor_shard",
	 ...
	 {"models/powerups/armor/pad_shard.md3", 0, 0, 0},
	 /* icon */ "icons/padshard",
	 /* pickup */ "PAD SHARD",
	 5,
	 IT_ARMOR,
	...
	{"item_armor_padshield",
	 ...
	 {"models/powerups/armor/pad_shield.md3", 0, 0, 0},
	 /* icon */ "icons/padshild",
	 /* pickup */ "PAD SHiELD",
	 100,
	 IT_ARMOR,
	...
	{"weapon_punchy",
	 ...
	 {"models/weapons2/punchy/punchy.md3", 0, 0, 0},
	...
	{"weapon_nipper",
	 ...
	 {"models/weapons2/nipper/nipper.md3", 0, 0, 0},
	...
	{"weapon_boaster",
	 ...
	 {"models/weapons2/boaster/boaster.md3", 0, 0, 0},
	...
	{"weapon_splasher",
	 ...
	 {"models/weapons2/splasher/splasher.md3", 0, 0, 0},
	...
	{"weapon_bubbleg",
	 ...
	 {"models/weapons2/bubbleg/bubbleg.md3", 0, 0, 0},
	...
	{"weapon_balloony",
	 ...
	 {"models/weapons2/balloony/balloony.md3", 0, 0, 0},
	...
	{"weapon_betty",
	 ...
	 {"models/weapons2/betty/betty.md3", 0, 0, 0},
	...
	{"weapon_pumper",
	 ...
	 {"models/weapons2/pumper/pumper.md3", 0, 0, 0},
	...
	{"weapon_imperius",
	 ...
	 {"models/weapons2/imperius/imperius.md3", 0, 0, 0},
	...
	{"weapon_killerducks",
	 ...
	 {"models/weapons2/killerducks/pad_killerduck_pu.md3", 0, 0, 0},
	...
	{"weapon_spraypistol",
	 ...
	 {"models/weapons2/spraypistol/spraypistol.md3", 0, 0, 0},
	...
	{"ammo_pumper",
	 ...
	 {"models/powerups/ammo/pumper_am.md3", 0, 0, 0},
	...
	{"ammo_nipper",
	 "sounds/weapons/ammo/ammo_pickup",
	 {"models/powerups/ammo/nipper_am.md3", 0, 0, 0},
	...
	{"ammo_balloony",
	 "sounds/weapons/ammo/ammo_pickup",
	 {"models/powerups/ammo/balloony_am.md3", 0, 0, 0},
	...
	{"ammo_bubbleg",
	 "sounds/weapons/ammo/ammo_pickup",
	 {"models/powerups/ammo/bubbleg_am.md3", 0, 0, 0},
	...
	{"ammo_boaster",
	 "sounds/weapons/ammo/ammo_pickup",
	 {"models/powerups/ammo/boaster_am.md3", 0, 0, 0},
	...
	{"ammo_betty",
	 "sounds/weapons/ammo/ammo_pickup",
	 {"models/powerups/ammo/betty_am.md3", 0, 0, 0},
	...
	{"ammo_splasher",
	 "sounds/weapons/ammo/ammo_pickup",
	 {"models/powerups/ammo/splasher_am.md3", 0, 0, 0},
	...
	{"ammo_imperius",
	 "sounds/weapons/ammo/ammo_pickup",
	 {"models/powerups/ammo/imperius_am.md3", 0, 0, 0},
	...
	{"ammo_spray_r",
	 ...
	 {"models/weapons2/spraypistol/cart_red.md3", 0, 0, 0},
	...
	{"ammo_spray_b",
	 "sounds/weapons/ammo/spraypistol/cartridges",
	 {"models/weapons2/spraypistol/cart_blue.md3", 0, 0, 0},
	...
	{"ammo_spray_n",
	 "sounds/weapons/ammo/spraypistol/cartridges",
	 {"models/weapons2/spraypistol/cart_neutral.md3", 0, 0, 0},
	...
	{"holdable_floater",
	 ...
	 {"models/powerups/instant/floater.md3", "models/powerups/instant/floater_ring.md3", 0, 0},
	 /* icon */ "icons/floater",
	 /* pickup */ "FLOATER",
	 60,
	 IT_HOLDABLE,
	...
	{"holdable_killerducks",
	 "sounds/names/weapons/killerducks",
	 {"models/weapons2/killerducks/pad_killerduck_pu.md3", "models/powerups/instant/killerducks_ring.md3", 0, 0},
	 /* icon */ "icons/killerducks",
	 /* pickup */ "KiLLERDUCKS",
	 60,
	 IT_HOLDABLE,
	...
	{"holdable_bambam",
	 ...
	 {"models/powerups/instant/bambam.md3", "models/powerups/instant/bambam_ring.md3", 0, 0},
	 /* icon */ "icons/bambam",
	 /* pickup */ "BAMBAM",
	 60,
	 IT_HOLDABLE,
	...
	{"holdable_boomies",
	 ...
	 {"models/powerups/instant/boomies.md3", "models/powerups/instant/boomies_ring.md3", 0, 0},
	 /* icon */ "icons/boomies",
	 /* pickup */ "BOOMiES",
	 60,
	 IT_HOLDABLE,
	 ...
	 */
	{
		...
		{"models/powerups/instant/padpower.md3", "models/powerups/instant/padpower_ring.md3", 0, 0},
		/* icon */ "icons/padpower",
		/* pickup */ "PADPOWER",
		30,
		IT_POWERUP,
	...
	{"item_climber",
	 ...
	 {"models/powerups/instant/climber.md3", "models/powerups/instant/climber_ring.md3", 0, 0},
	 /* icon */ "icons/climber",
	 /* pickup */ "CLiMBER",
	 30,
	 IT_POWERUP,
	...
	{"item_speedy",
	 ...
	 {"models/powerups/instant/speedy.md3", "models/powerups/instant/speedy_ring.md3", 0, 0},
	 /* icon */ "icons/speedy",
	 /* pickup */ "SPEEDY",
	 30,
	 IT_POWERUP,
	...
	{"item_visionless",
	 ...
	 {"models/powerups/instant/visionless.md3", "models/powerups/instant/visionless_ring.md3", 0, 0},
	...
	{"item_revival",
	 ...
	 {"models/powerups/instant/revival.md3", "models/powerups/instant/revival_ring.md3", 0, 0},
	 /* icon */ "icons/revival",
	 /* pickup */ "REViVAL",
	 30,
	 IT_POWERUP,
	...
	*/
	{"team_CTL_redlolly",
	 NULL,
	 {"models/ctl/lollipop_red.md3", 0, 0, 0},
	...
	*/
	{"team_CTL_bluelolly",
	 NULL,
	 {"models/ctl/lollipop_blue.md3", 0, 0, 0},
	...
	{"weapon_kma97", // "Kiss My Ass 97"
	 ...
	 {"models/weapons2/kma97/kma97.md3", 0, 0, 0},
	...
	{"ammo_kma97", // "Kiss My Ass 97"
	 "sounds/weapons/ammo/ammo_pickup",
	 {"models/powerups/ammo/kma97_am.md3", 0, 0, 0},

...
char *ui_medalSounds[] = {"sound/feedback/accuracy", "sound/feedback/impressive_a", "sound/feedback/excellent_a",
						  "sound/feedback/gauntlet", "sound/feedback/frags",		"sound/feedback/perfect"};
...
void UI_SPPostgameMenu_f(void) {
	...
	if (playerGameRank != 1) {
		postgameMenuInfo.winnerSound =
			trap_S_RegisterSound(va("sound/wop_player/announce/%s_wins", postgameMenuInfo.placeNames[0]), qfalse);
